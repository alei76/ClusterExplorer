...
public class Vertex {
	 ...
	 *            ID of the vertex
	 * @param border
	 *            defines if the vertex is a border vertex or not in the
	...
	/**
	 * Returns true if the vertex is a border vertex of the triangulation
	 ...
	 * 
	 * @param border
	 *            true if the edge is a border edge, false otherwise
	 */
